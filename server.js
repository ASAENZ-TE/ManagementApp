...
const startScreen = ['View all of the Employees', 'View all by Department', 'View all by Manager', 'Add an Employee!', 'Remove an Employee', 'Update a Role', 'View all the Roles', 'Add Role', 'Remove Role', 'View all Departments', 'Add Department', 'Remove Department', 'Exit']
